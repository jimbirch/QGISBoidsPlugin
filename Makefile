...
SOURCES = \
	__init__.py \
	Boids_Model.py Boids_Model_dialog.py

PLUGINNAME = Boids_Model

PY_FILES = \
	__init__.py \
	Boids_Model.py Boids_Model_dialog.py

UI_FILES = Boids_Model_dialog_base.ui
...
QGISDIR=/home/jim/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
